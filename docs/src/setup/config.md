...
The default file is called `DownstreamTester.json` and placed in the top folder of the repository. 
You can however give a different configuration file/path through the keyword arguments.
